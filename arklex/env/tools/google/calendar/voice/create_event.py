...
def create_event(name: str, description: str, event_name: str, start_time: str, timezone: str, duration=30, **kwargs) -> str:
    ...
    logger.info(f"checking for twilio client: {kwargs.get('twilio_client')}, phone_no_to: {kwargs.get('phone_no_to')}, phone_no_from: {kwargs.get('phone_no_from')}")
    if kwargs.get("twilio_client") and kwargs.get("phone_no_to") and kwargs.get("phone_no_from"):
