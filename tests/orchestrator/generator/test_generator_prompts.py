...
def test_prompt_templates_are_strings() -> None:
    """Test that all top-level prompt templates are strings."""
...
def test_prompt_manager_init(prompt_manager: prompts.PromptManager) -> None:
    """Test PromptManager initialization and attribute setup."""
...
def test_get_prompt_valid(
    prompt_manager: prompts.PromptManager, sample_prompt_fields: Set[str]
) -> None:
    """Test get_prompt with valid prompt names and required kwargs."""
...
def test_get_prompt_invalid_name(
    prompt_manager: prompts.PromptManager, invalid_prompt_name: str
) -> None:
...
def test_get_prompt_missing_kwargs(prompt_manager: prompts.PromptManager) -> None:
    """Test get_prompt with missing required kwargs."""
    # Should raise KeyError if required kwarg is missing
...
def test_get_prompt_extra_kwargs(
    prompt_manager: prompts.PromptManager, valid_prompt_kwargs: dict
) -> None:
    """Test get_prompt with extra kwargs that should be ignored."""
...
def test_prompt_manager_repr(prompt_manager: prompts.PromptManager) -> None:
    """Test PromptManager string representation."""
