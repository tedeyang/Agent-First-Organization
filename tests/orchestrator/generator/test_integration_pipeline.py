...
@pytest.fixture
def complex_tasks_config(patched_sample_config):
...
@pytest.fixture
def nested_graph_config(sample_config):
...
@pytest.fixture
def custom_prompts_config(sample_config):
...
@pytest.fixture
def performance_config(sample_config):
...
class TestFullGenerationPipeline:
    ...
    def test_pipeline_with_intent_generation(self, patched_sample_config) -> None:
    ...
    def test_pipeline_with_complex_tasks(
        self, complex_tasks_config, always_valid_mock_model
    ) -> None:
    ...
    def test_pipeline_with_nested_graphs(
        self, nested_graph_config, nested_graph_mock_model
    ) -> None:
    ...
    def test_pipeline_with_custom_prompts(self, custom_prompts_config) -> None:
    ...
    def test_pipeline_performance(
        self, performance_config, performance_mock_model
    ) -> None:
