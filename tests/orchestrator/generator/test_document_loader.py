"""Test suite for the Arklex document loading components.

This module contains comprehensive tests for the document loading, processing,
and validation components of the Arklex framework. It includes unit tests
for individual components and integration tests for the complete document
handling pipeline.
"""
...
@pytest.fixture
def document_loader(mock_file_system):
